const de = {
  ...
  hero_desc: "Chuncho-Kakao aus Cusco. Geerntet von Familien, die wieder zu glauben begannen, und in Körner reiner Hoffnung verwandelt. Von unserer Niederlassung in der Tschechischen Republik öffnen wir Europa die Arme, um diesen trockenen Schatz zu liefern und sicherzustellen, dass jeder Winkel des Kontinents ihre Namen, ihren Kampf und ihre Geschichten unversehrt erhält.",
